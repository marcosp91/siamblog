@extends ('template.header')
    ...
    @section('title', 'Mais nutrição e saúde para você.')
    ...
    <div class="container-fluid pb-2">
        <div class="row">
            <div class="col-sm-12">
                @if (\Session::has('mensagemErro'))
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        ...
                        <div class="text-center">
                            <strong>Por favor,</strong> {!! \Session::get('mensagemErro') !!}
                        </div>
                    </div>
                @endif
                @if ($errors->any())
                ...
                @endif
                @if (\Session::has('mensagemDesconto'))
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                             <span aria-hidden="true">&times;</span>
                        </button>
                        <div class="text-center">
                            <strong>Muito Bem! </strong>{!! \Session::get('mensagemDesconto') !!}
                        </div>
                    </div>
                @endif
                @if (\Session::has('mensagemSucesso'))
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        ...
                        <div class="text-center">
                            <strong>Bem Vindo! </strong>{!! \Session::get('mensagemSucesso') !!}
                        </div>
                    </div>
                @endif
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-10 col-md-4 col-lg-4 col-xs-12 p-3 grid-container">
                <div class="card-wrapper">
                    <a href="{{ route('exames-essenciais') }}" class="hov-card">
                        <div class="card-img">
                            <img src="{{ asset('/images/conteudo/work-hard.jpeg') }}" class="img-fluid" alt="Cuidados no Treino Físico">
                        </div>
                        <div class="card-post-heading">
                            <div class="card-title">
                                <h3>
                                    Conheça os 5 exames essenciais antes de começar uma dieta ou praticar exercícios físicos
                                </h3>
                            </div>
                            <div class="card-text">
                                <p>
            ...
            <div class="col-sm-10 col-md-4 col-lg-4 col-xs-12 p-3 grid-container">
                <div class="card-wrapper">
                    <a href="{{ route('efeito-safona') }}"  class="hov-card">
                       <div class="card-img">
                          <img src="{{ asset('/images/conteudo/secar-barriga.jpeg') }}" class="img-fluid" alt="Emagrecimento Efeito Sanfona">
                       </div>
                       <div class="card-post-heading">
                          <div class="card-title">
                             <h3>
            ...
            <div class="col-sm-10 col-md-4 col-lg-4 p-3 grid-container">
                <div class="card-wrapper">
                    <a href="{{ route('estilos-cabelos') }}" class="hov-card">
                       <div class="card-img">
                          <img src="{{ asset('/images/conteudo/melhores-estilos-cabelos.jpeg') }}" class="img-fluid" alt="Melhore Estilos de Cabelo">
                        </div>
                        <div class="card-post-heading">
                            <div class="card-title">
                                <h3>
